...
class PaginationController extends Controller
{
    ...
    public function warehouseCurrentStockListPaginationBarcodeNoCheckCurrentStock(Request $request){

        $warehouse_stock_product = DB::table('products')
            ->leftJoin('warehouse_current_stocks','warehouse_current_stocks.product_id','products.id')
    ...
    public function warehouseCurrentStockListPaginationItemcodeNoCheckCurrentStock(Request $request){
    ...
    public function warehouseCurrentStockListPaginationProductNameNoCheckCurrentStock(Request $request){
